...
const Join = React.lazy(
  () => import(/* webpackPrefetch: true */ 'pages/join/Join')
);
...
const BackOffice = React.lazy(
  () => import(/* webpackPrefetch: true */ 'pages/backoffice')
);
        ...
        <React.Suspense fallback={<Loading />}>
          <Switch>
            <Route
              exact
              path="/"
              component={isDesktopApp ? WelcomePage : LandingPage}
            />
            <Route path="/login" component={Login} />
            <Route path="/join" component={Join} />
            <Route path="/deleted" component={DeletedPage} />
            <Route
              path="/inactive-version"
              component={InactiveAppVersionPage}
            />
